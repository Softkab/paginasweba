...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="http://grapesjs.com/stylesheets/toastr.min.css">
    <link rel="stylesheet" href="http://grapesjs.com/stylesheets/grapes.min.css?v0.12.15">
    <link rel="stylesheet" href="http://grapesjs.com/stylesheets/grapesjs-preset-webpage.css">
    <link rel="stylesheet" href="http://grapesjs.com/stylesheets/tooltip.css">
    <link rel="stylesheet" href="http://grapesjs.com/stylesheets/perfect-scrollbar.css">
    <link rel="stylesheet" href="http://grapesjs.com/stylesheets/grapesjs-plugin-filestack.css">
    ...
    <script src="http://grapesjs.com/js/perfect-scrollbar.min.js"></script>
    <script src="http://grapesjs.com/js/toastr.min.js"></script>

    <script src="http://grapesjs.com/js/grapes.min.js?v0.12.15"></script>
    <script src="http://grapesjs.com/js/grapesjs-plugin-export.min.js"></script>
    <script src="http://grapesjs.com/js/grapesjs-plugin-filestack.min.js"></script>
    <script src="http://grapesjs.com/js/grapesjs-blocks-basic.min.js"></script>
    <script src="http://grapesjs.com/js/grapesjs-preset-webpage.js"></script>
    <script src="http://grapesjs.com/js/grapesjs-plugin-forms.min.js"></script>
    <script src="http://grapesjs.com/js/grapesjs-aviary.min.js"></script>
    <script src="http://grapesjs.com/js/grapesjs-navbar.min.js"></script>
    <script src="http://grapesjs.com/js/grapesjs-component-countdown.min.js"></script>
